...
for n in range(min_ticks, (max_ticks+1)):
    ...
    for j in range(1, (r+1)):
        ...
        rr = "Rscript /home1/02540/kellypie/UT_ddRADseq/save_R2_hist.r --args " + plinkResults + outfile2 + outfile3 + str(n) + '_unfiltered'
        ...
        rr2 = "Rscript /home1/02540/kellypie/UT_ddRADseq/save_R2_hist.r --args " + plinkResults + outfile2 + outfile3 + str(n) + '_filtered'
