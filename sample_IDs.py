...
for n in range(min_ticks, (max_ticks+1)):
    ...
    for j in range(1, (r+1)):
        ...
        # -- full file
        fullPlink = "plink --file " + tempOutDir + "/vcf_tmp_plink --r2 --matrix --noweb --out " + tempOutDir + '/plink.ld'
        ...
        # -- filtered file
        filteredPlink = "plink --file " + tempOutDir + "/vcf_uniqueOnly_tmp_plink --r2 --matrix --noweb --out " + tempOutDir + '/plink.ld'
